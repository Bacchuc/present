...
public interface StudentDao {
    ...
    // * @param student 插入的数据信息
    // */
    //Student insertPassword(Student student);
     ...
     * @return
     */
    String queryByIdForUniqueName(@Param("id") String studentId);
     ...
     * @return
     */
    void deleteByIdForUniqueName(@Param("id") String studentId,@Param("imel") String imel);
