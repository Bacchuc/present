...
public class StudentLoginService extends BaseService<StudentLoginSuccessDto> {
    ...
    public ResponseDto<StudentLoginSuccessDto> process(JSONObject params, HttpServletRequest request, HttpServletResponse response) {
        CheckUtil.checkEmpty(params, "password", "phone", "imel");
        return studentLogin(params.getString("phone"), params.getString("password"), params.getString("imel"));
    }
     ...
     * @return
     */
    public ResponseDto<StudentLoginSuccessDto> studentLogin(String phone, String password,String imel) {
        ...
        responseDto.setData(convertStudentToStudentLoginSuccessDto(student, Jwt.getToken(student.getId())));
        return responseDto;
    }
     ...
     * @return
     */
    public static StudentLoginSuccessDto convertStudentToStudentLoginSuccessDto(final Student student, final String token) {
        ...
        if (student != null) {
            ...
            studentLoginSuccessDto.setToken(token);
